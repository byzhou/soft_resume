...
\begin{itemize}
    ...
    %     Android game programming according to an online tutorial.
    ...
    %     \item \verb+Latex Compiling Environment+
    %     
    %     Contribute to a latex compiling environment that can compile tex to presentation/paper/poster.

    %     \item Feel free to go to \url{http://github.com/byzhou}, and you will find more interesting
    %     projects than I list here.
